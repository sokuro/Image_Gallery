package com.sokuro.imagegallery.controller;

import com.sokuro.imagegallery.entity.ImageGallery;
import com.sokuro.imagegallery.service.ImageGalleryService;
        ...
        try {
            ...
            if (id != 0) {
                ...
                if (imageGallery.isPresent()) {
                    ...
                    model.addAttribute("year", imageGallery.get().getYear());
                    return "imagedetails";
                }
